...
import { ClearNotification } from "../App/Buttons";
...
const DashAlertCard = (props: DashAlertCardProps) => {
  ...
  return (
    <div className={dashClass}>
      <Card.Title>
        <div className='dashboard__card-header'><ICOBELL /> Notifications</div>
        {!isReq && notifLength > 0 && (
          <ClearNotification handleClick={handleClick} />
        )}
      </Card.Title>
      <div className='red'><ICOURGENT/>Upon function that may add notification, ensure dispatch notification</div>
      <Card.Text>
        {notifLength > 0 && isReq ? (
          <span>
